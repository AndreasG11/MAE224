...
In order to plot <img src="https://github.com/d008/MAE224/blob/master/equations/Cp.png">, press the "opPoint view" button (located in the "view" drop down menu in the top left). You should now see your pressure coefficient plotted against the normalized chord position of your airfoil. Adjust the angle of attack by changing the drop-down menu labeled "Operation Points".  
