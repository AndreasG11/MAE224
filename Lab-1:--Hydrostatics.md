...
4.    Using Matlab, and the `analogRead()` command, capture **at least** 20 data points at each height and record the corresponding heights.
...
8.    Save your data to a text file using the Matlab command snippet below:
